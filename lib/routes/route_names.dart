class RouteNames {
  ...
  // ========== 설정 ==========
  static const String idChange = '/home/settings/id-change';                // 아이디 변경
  static const String passwordChange = '/home/settings/password-change';    // 비밀번호 변경
  static const String nicknameChange = '/home/settings/nickname-change';    // 닉네임 변경
  static const String communityChange = '/home/settings/community-change';  // 커뮤니티 변경
  static const String myPosts = '/home/settings/my-posts';                  // 내가 쓴 게시물
  static const String myComments = '/home/settings/my-comments';            // 내가 쓴 댓글
}
